  ...
  try {
    ...
    try {
      ...
      if (profileData.education !== undefined) {
        ...
        profileUpdateValues.push(JSON.stringify(profileData.education));
      }
      ...
      const updatedProfile = {
        ...
        qualifications: updatedRow.qualifications ? JSON.parse(updatedRow.qualifications) : [],
        education: updatedRow.education ? JSON.parse(updatedRow.education) : [],
        areasOfSpecialty: updatedRow.areas_of_specialty ? JSON.parse(updatedRow.areas_of_specialty) : [],
