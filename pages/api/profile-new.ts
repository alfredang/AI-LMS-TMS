...
async function getTrainingProviderProfile(userId: string) {
  ...
  return {
    ...
    ssgApp1CertFile: profileData.ssg_app1_cert_file || '',
    ssgApp1PrivateKeyFile: profileData.ssg_app1_private_key_file || '',
    ssgApp1EncryptionKey: profileData.ssg_app1_encryption_key || '',
    ssgApp3CertFile: profileData.ssg_app3_cert_file || '',
    ssgApp3PrivateKeyFile: profileData.ssg_app3_private_key_file || '',
    ssgApp3EncryptionKey: profileData.ssg_app3_encryption_key || '',
