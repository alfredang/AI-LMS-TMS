...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        // 1. Locate specific Course Folder mathematically 
        ...
        // 2. Firmly locate 'Certificates' subfolder (prevent duplicates)
        ...
        // 3. Upload & intelligently overwrite PDF to avoid duplicated file bloat
        ...
        if (existingFileRes.data.files && existingFileRes.data.files.length > 0) {
            ...
            // Public reading is theoretically already granted if it previously existed
