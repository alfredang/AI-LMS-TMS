...
const FinalCourseConfirmationEmailTemplateView: React.FC = () => {
  ...
  const handleSendTestEmail = async () => {
    ...
    try {
      const res = await fetch(getApiUrl('/api/training-provider/send-test-email'), { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ testEmail: testEmail.trim(), subject, body, templateType: 'final-course-confirmation' }) });
