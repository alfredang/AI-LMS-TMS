...
const Header: React.FC = () => {
  ...
  const tpgManagementPages = [AdminPage.ApplyNewGrant, AdminPage.ViewGrantStatus, AdminPage.SubmitAssessment, AdminPage.ApplyNewClaim, AdminPage.UploadCourseRuns, AdminPage.UploadEnrolments];
