...
const Header: React.FC = () => {
  ...
  const tpgManagementPages = [AdminPage.ApplyNewGrant, AdminPage.ViewGrantStatus, AdminPage.SubmitAssessment, AdminPage.ViewAssessments, AdminPage.ApplyNewClaim, AdminPage.UploadCourseRuns, AdminPage.UploadEnrolments];
