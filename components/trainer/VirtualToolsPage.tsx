...
const VIRTUAL_TOOLS = [
  ...
  },
  {
    ...
    description: 'Collaborate and host virtual meetings with Microsoft Teams',
    icon: IconName.Video,
    href: 'https://www.microsoft.com/en-sg/microsoft-teams/log-in',
  },
  {
    title: 'Zoom',
    description: 'Host and join video conferences with Zoom',
    icon: IconName.Video,
    href: 'https://www.zoom.com/',
  },
];

const VirtualToolsPage: React.FC = () => {
  return (
    <div>
      <h2 className="text-3xl font-bold mb-6 dark:text-white">Virtual Tools</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {VIRTUAL_TOOLS.map(tool => (
          <a
            key={tool.title}
            href={tool.href}
            target="_blank"
...
export default VirtualToolsPage;
