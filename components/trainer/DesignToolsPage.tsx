...
const DESIGN_TOOLS = [
  {
    title: 'Logo Maker',
    description: 'Generate professional logos from a text prompt and download them as PNG',
...
const DesignToolsPage: React.FC = () => {
  return (
    <div>
      <h2 className="text-3xl font-bold mb-6 dark:text-white">Design Tools</h2>
