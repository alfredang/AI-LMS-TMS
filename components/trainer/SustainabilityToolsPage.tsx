...
const SustainabilityToolsPage: React.FC = () => {
  return (
    <div>
      <h2 className="text-3xl font-bold mb-6 dark:text-white">Sustainability Tools</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {SUSTAINABILITY_TOOLS.map(tool => (
          <a
            key={tool.title}
            href={tool.href}
            target="_blank"
...
export default SustainabilityToolsPage;
