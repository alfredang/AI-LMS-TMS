    ...
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
          Searches Google Calendar events from the past 6 months to 3 months ahead
        </p>
      </div>
      ...
      {searchResults !== null && (
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button onClick={clearSearch} className="text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium">
              Clear results
            </button>
          </div>
                ...
                return (
                  <div key={event.id} className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-3 flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors"
                    >
                      <svg
                      ...
                      <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-4 space-y-4">
                        ...
                        {event.description && (
                          <div>
                            ...
                            <div
                              className="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap break-words max-h-40 overflow-y-auto"
                        ...
                        {event.location && (
                          <div>
                            <h4 className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Location</h4>
                        ...
                        {event.meetLink && (
                          <div>
                            <h4 className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Google Meet</h4>
                            <a href={event.meetLink} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 dark:text-blue-400 hover:underline break-all">
                              {event.meetLink}
                            </a>
                          </div>
                        )}
                        ...
                        {event.organizer && (
                          <div>
                            <h4 className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Organizer</h4>
                            ...
                            <div className="space-y-1.5">
                              {event.attendees.map((a, i) => (
                                <div key={i} className="flex items-center gap-2 text-sm">
                                  <span className={`inline-block px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase ${statusColors[a.status] || statusColors.needsAction}`}>
                                  ...
                                  {a.organizer && (
                                    <span className="text-[10px] font-semibold text-blue-600 dark:text-blue-400 uppercase">organizer</span>
                                  )}
                                </div>
                              ))}
                            </div>
