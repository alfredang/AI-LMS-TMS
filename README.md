...
- **Critical Reminders** — a red-bordered block pinned under the course page's left menu (after *Announcements*) in Trainer mode, listing the three sign-off duties that gate payout: TRAQOM is mandatory (a learner who misses the survey delays the trainer payout), mark each learner Competent in Assessment Grading once all assessments are in, and digitally sign each learner's assessment there; the grading items jump straight to the Grading section
