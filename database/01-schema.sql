...
CREATE TABLE public.course_run (
    ...
    virtual_meeting_external_id text,
    virtual_meeting_host_link text,
    virtual_meeting_password text,
    virtual_meeting_status text,
    virtual_meeting_synced_at timestamp with time zone,
...
CREATE TABLE public.training_provider (
    ...
    zoom_oauth_client_id text,
    zoom_oauth_client_secret text,
    zoom_oauth_refresh_token text,
    zoom_oauth_access_token text,
    zoom_oauth_token_expires_at timestamp with time zone,
...
--
-- Name: feedback_form_template; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.feedback_form_template (
...
CREATE UNIQUE INDEX uq_feedback_form_template_provider
    ON public.feedback_form_template(training_provider_id);

--
-- Name: feedback_form_response; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.feedback_form_response (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
