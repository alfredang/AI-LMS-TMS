  ...
  const renderContent = () => {
    ...
    if (currentView === View.Scheduler) {
      switch (adminPage) {
        ...
        case AdminPage.AutoGenerateProformaInvoicesLog: return <AutoGenerateProformaInvoicesLogView />;
        case AdminPage.AutoGenerateDaInvoicesLog: return <AutoGenerateDaInvoicesLogView />;
