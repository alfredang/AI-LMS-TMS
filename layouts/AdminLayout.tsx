...
const PAGE_LABELS: Partial<Record<AdminPage, string>> = {
  ...
  [AdminPage.AutoGenerateProformaInvoicesLog]: 'Auto Generate Proforma Invoices Log',
  [AdminPage.AutoGenerateDaInvoicesLog]: 'Auto Generate DA Invoices Log',
  [AdminPage.AutoSanitiseDataLog]: 'Auto Sanitise Data Log',
  [AdminPage.MailerliteSyncLog]: 'MailerLite Sync Log',
...
const AdminLayout: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    switch (adminPage) {
      ...
      case AdminPage.AutoGenerateProformaInvoicesLog:
        return <AutoGenerateProformaInvoicesLogView />;
      case AdminPage.AutoGenerateDaInvoicesLog:
        return <AutoGenerateDaInvoicesLogView />;
      case AdminPage.AutoSanitiseDataLog:
        return <AutoSanitiseDataLogView />;
      case AdminPage.MailerliteSyncLog:
        return <MailerliteSyncLogView />;
