function direct_application_enrolment() {
  const WEBHOOK_URL = "https://n8n.srv1231536.hstgr.cloud/webhook/66426d42-7398-461b-b0c8-5e13013978f5";
  ...
  try {
    ...
    if (statusCode === 200) {
      ...
      ss.toast('Direct application enrolment sent successfully!', '✅ Success', 5);
